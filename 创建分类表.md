    ...
    <table class="add_tab">
        <tbody>
            <tr>
                ...
                <td>
                    <select name="catepid">
                        ...
                        @foreach($data as $d)
                        <option value="{{ $d->cateid }}">{{ $d->catename }}</option>
                        @endforeach
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="catetitle">
                    <p>标题可以写30个字</p>
                </td>
            </tr>
            <tr>
                <th>关键词描述：</th>
                <td>
                    <textarea name="catekeywords"></textarea>
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>排序：</th>
                <td>
                    <input type="text" class="sm" name="cateorder">
                </td>
            </tr>
            <tr>
                <th></th>
